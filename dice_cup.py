...
def h_main():
    ...
    print('  -q Quiet Mode: only displays the Dice Group roll outcomes delimited by a comma.')
    print('     Sets are separated by a new line, only one Set is printed per line.\n')
